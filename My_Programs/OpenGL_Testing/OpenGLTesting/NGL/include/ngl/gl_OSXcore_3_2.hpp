...
namespace gl
{
	namespace exts
	{
		...
		extern LoadTest var_ARB_occlusion_query2;
		extern LoadTest var_ARB_shader_bit_encoding;
		extern LoadTest var_ARB_timer_query;
		extern LoadTest var_EXT_depth_bounds_test;
		extern LoadTest var_EXT_framebuffer_multisample_blit_scaled;
		extern LoadTest var_EXT_texture_mirror_clamp;
		extern LoadTest var_EXT_texture_sRGB_decode;
		extern LoadTest var_APPLE_client_storage;
		extern LoadTest var_APPLE_object_purgeable;
		extern LoadTest var_APPLE_rgb_422;
		extern LoadTest var_APPLE_row_bytes;
		extern LoadTest var_APPLE_texture_range;
	...
	namespace _detail
	{
		...
		extern void (CODEGEN_FUNCPTR *DepthBoundsEXT)(GLclampd zmin, GLclampd zmax);
		
		
		
		
		
		extern void (CODEGEN_FUNCPTR *GetObjectParameterivAPPLE)(GLenum objectType, GLuint name, GLenum pname, GLint * params);
		extern GLenum (CODEGEN_FUNCPTR *ObjectPurgeableAPPLE)(GLenum objectType, GLuint name, GLenum option);
		extern GLenum (CODEGEN_FUNCPTR *ObjectUnpurgeableAPPLE)(GLenum objectType, GLuint name, GLenum option);
		
		
		
		extern void (CODEGEN_FUNCPTR *GetTexParameterPointervAPPLE)(GLenum target, GLenum pname, GLvoid ** params);
		extern void (CODEGEN_FUNCPTR *TextureRangeAPPLE)(GLenum target, GLsizei length, const GLvoid * pointer);
	...
	inline void DepthBoundsEXT(GLclampd zmin, GLclampd zmax){_detail::DepthBoundsEXT(zmin, zmax);}
	
	
	
	
	
	inline void GetObjectParameterivAPPLE(GLenum objectType, GLuint name, GLenum pname, GLint * params){_detail::GetObjectParameterivAPPLE(objectType, name, pname, params);}
	inline GLenum ObjectPurgeableAPPLE(GLenum objectType, GLuint name, GLenum option){return _detail::ObjectPurgeableAPPLE(objectType, name, option);}
	inline GLenum ObjectUnpurgeableAPPLE(GLenum objectType, GLuint name, GLenum option){return _detail::ObjectUnpurgeableAPPLE(objectType, name, option);}
	
	
	
	inline void GetTexParameterPointervAPPLE(GLenum target, GLenum pname, GLvoid ** params){_detail::GetTexParameterPointervAPPLE(target, pname, params);}
	inline void TextureRangeAPPLE(GLenum target, GLsizei length, const GLvoid * pointer){_detail::TextureRangeAPPLE(target, length, pointer);}
